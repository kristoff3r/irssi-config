...
class SendMessage(object):
    def __init__(self, client_jid, secret, to_jid, message, check_online=True):
        ...
        connector = XMPPClientConnector(reactor, 'google.com', f)
        connector.connect()
    ...
    def presence(self, elem):
        if not self.check_online and not self.sent_message:
    ...
    def send_the_message(self):
        ...
        message["type"] = "chat"
        message.addElement("body", "jabber:client", unicode(self.message, 'utf-8'))
